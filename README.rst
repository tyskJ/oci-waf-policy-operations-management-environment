...
=====================================================================
* `詳細 <https://qiita.com/tyskJ/items/f316c887b3b97f9f6672>`_
...
.. note::
  ...
  * ``notifications.tf`` 内の `oci_ons_subscription.functions` リソースコメントアウトを解除
  * 項番6でデプロイしたFunctionsのOCIDを、 ``oci.auto.tfvars`` 内の ``fn_ocid`` に追記し、以下コマンド実行
